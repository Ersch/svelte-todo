...
<AppShell class="h-screen w-full bg-black">
	<svelte:fragment slot="header"></svelte:fragment>
	<div class="flex h-full flex-col content-center items-center justify-center gap-5">
		<div>
			<p class="shrikhand-regular text-7xl">
				<span
